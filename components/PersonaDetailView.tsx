...
const PersonaDetailView: React.FC<PersonaDetailViewProps> = ({ persona, onBack }) => {
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6">
      <div className="bg-brand-secondary p-6 rounded-lg shadow-lg border border-brand-accent/30">
        <div className="flex justify-between items-start mb-6">
          ...
          <button onClick={onBack} className="bg-brand-primary hover:bg-brand-accent/20 px-4 py-2 rounded-lg transition-colors flex-shrink-0">
            &larr; Back to List
          </button>
        </div>
